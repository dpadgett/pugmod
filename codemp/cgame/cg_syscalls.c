...
void	trap_S_StartLocalSound( sfxHandle_t sfx, int channelNum ) {
	if( CG_Cvar_Int( "cg_noChatSound" ) && sfx == cgs.media.talkSound ) return;
...
#if 0
	if( id == cgs.effects.mSparks )
	{
		fxCount.mSparks = (fxCount.mSparks+1)%1000;
		if(fxCount.mSparks == 0)
			CG_Printf("Possible fx spam in mSparks!\n");
	} else if( id == cgs.effects.concussionShotEffect ) {
		fxCount.concussionShotEffect = (fxCount.concussionShotEffect+1)%1000;
		if(fxCount.concussionShotEffect == 0)
			CG_Printf("Possible fx spam in concussionShotEffect!\n");
	} else if( id == cgs.effects.concussionImpactEffect ) {
		fxCount.concussionImpactEffect = (fxCount.concussionImpactEffect+1)%1000;
		if(fxCount.concussionImpactEffect == 0)
			CG_Printf("Possible fx spam in concussionImpactEffect!\n");
	} else if( id == cgs.effects.bryarShotEffect ) {
		fxCount.bryarShotEffect = (fxCount.bryarShotEffect+1)%1000;
		if(fxCount.bryarShotEffect == 0)
			CG_Printf("Possible fx spam in bryarShotEffect!\n");
	} else if( id == cgs.effects.bryarPowerupShotEffect ) {
		fxCount.bryarPowerupShotEffect = (fxCount.bryarPowerupShotEffect+1)%1000;
		if(fxCount.bryarPowerupShotEffect == 0)
			CG_Printf("Possible fx spam in bryarPowerupShotEffect!\n");
	} else if( id == cgs.effects.bryarWallImpactEffect ) {
		fxCount.bryarWallImpactEffect = (fxCount.bryarWallImpactEffect+1)%1000;
		if(fxCount.bryarWallImpactEffect == 0)
			CG_Printf("Possible fx spam in bryarWallImpactEffect!\n");
	} else if( id == cgs.effects.bryarWallImpactEffect2 ) {
		fxCount.bryarWallImpactEffect2 = (fxCount.bryarWallImpactEffect2+1)%1000;
		if(fxCount.bryarWallImpactEffect2 == 0)
			CG_Printf("Possible fx spam in bryarWallImpactEffect2!\n");
	} else if( id == cgs.effects.bryarWallImpactEffect3 ) {
		fxCount.bryarWallImpactEffect3 = (fxCount.bryarWallImpactEffect3+1)%1000;
		if(fxCount.bryarWallImpactEffect3 == 0)
			CG_Printf("Possible fx spam in bryarWallImpactEffect3!\n");
	} else if( id == cgs.effects.bryarFleshImpactEffect ) {
		fxCount.bryarFleshImpactEffect = (fxCount.bryarFleshImpactEffect+1)%1000;
		if(fxCount.bryarFleshImpactEffect == 0)
			CG_Printf("Possible fx spam in bryarFleshImpactEffect!\n");
	} else if( id == cgs.effects.bryarDroidImpactEffect ) {
		fxCount.bryarDroidImpactEffect = (fxCount.bryarDroidImpactEffect+1)%1000;
		if(fxCount.bryarDroidImpactEffect == 0)
			CG_Printf("Possible fx spam in bryarDroidImpactEffect!\n");
	} else if( id == cgs.effects.blasterShotEffect ) {
		fxCount.blasterShotEffect = (fxCount.blasterShotEffect+1)%1000;
		if(fxCount.blasterShotEffect == 0)
			CG_Printf("Possible fx spam in blasterShotEffect!\n");
	} else if( id == cgs.effects.blasterWallImpactEffect ) {
		fxCount.blasterWallImpactEffect = (fxCount.blasterWallImpactEffect+1)%1000;
		if(fxCount.blasterWallImpactEffect == 0)
			CG_Printf("Possible fx spam in blasterWallImpactEffect!\n");
	} else if( id == cgs.effects.blasterFleshImpactEffect ) {
		fxCount.blasterFleshImpactEffect = (fxCount.blasterFleshImpactEffect+1)%1000;
		if(fxCount.blasterFleshImpactEffect == 0)
			CG_Printf("Possible fx spam in blasterFleshImpactEffect!\n");
	} else if( id == cgs.effects.blasterDroidImpactEffect ) {
		fxCount.blasterDroidImpactEffect = (fxCount.blasterDroidImpactEffect+1)%1000;
		if(fxCount.blasterDroidImpactEffect == 0)
			CG_Printf("Possible fx spam in blasterDroidImpactEffect!\n");
	} else if( id == cgs.effects.disruptorRingsEffect ) {
		fxCount.disruptorRingsEffect = (fxCount.disruptorRingsEffect+1)%1000;
		if(fxCount.disruptorRingsEffect == 0)
			CG_Printf("Possible fx spam in disruptorRingsEffect!\n");
	} else if( id == cgs.effects.disruptorProjectileEffect ) {
		fxCount.disruptorProjectileEffect = (fxCount.disruptorProjectileEffect+1)%1000;
		if(fxCount.disruptorProjectileEffect == 0)
			CG_Printf("Possible fx spam in disruptorProjectileEffect!\n");
	} else if( id == cgs.effects.disruptorWallImpactEffect ) {
		fxCount.disruptorWallImpactEffect = (fxCount.disruptorWallImpactEffect+1)%1000;
		if(fxCount.disruptorWallImpactEffect == 0)
			CG_Printf("Possible fx spam in disruptorWallImpactEffect!\n");
	} else if( id == cgs.effects.disruptorFleshImpactEffect ) {
		fxCount.disruptorFleshImpactEffect = (fxCount.disruptorFleshImpactEffect+1)%1000;
		if(fxCount.disruptorFleshImpactEffect == 0)
			CG_Printf("Possible fx spam in disruptorFleshImpactEffect!\n");
	} else if( id == cgs.effects.disruptorAltMissEffect ) {
		fxCount.disruptorAltMissEffect = (fxCount.disruptorAltMissEffect+1)%1000;
		if(fxCount.disruptorAltMissEffect == 0)
			CG_Printf("Possible fx spam in disruptorAltMissEffect!\n");
	} else if( id == cgs.effects.disruptorAltHitEffect ) {
		fxCount.disruptorAltHitEffect = (fxCount.disruptorAltHitEffect+1)%1000;
		if(fxCount.disruptorAltHitEffect == 0)
			CG_Printf("Possible fx spam in disruptorAltHitEffect!\n");
	} else if( id == cgs.effects.bowcasterShotEffect ) {
		fxCount.bowcasterShotEffect = (fxCount.bowcasterShotEffect+1)%1000;
		if(fxCount.bowcasterShotEffect == 0)
			CG_Printf("Possible fx spam in bowcasterShotEffect!\n");
	} else if( id == cgs.effects.bowcasterImpactEffect ) {
		fxCount.bowcasterImpactEffect = (fxCount.bowcasterImpactEffect+1)%1000;
		if(fxCount.bowcasterImpactEffect == 0)
			CG_Printf("Possible fx spam in bowcasterImpactEffect!\n");
	} else if( id == cgs.effects.repeaterProjectileEffect ) {
		fxCount.repeaterProjectileEffect = (fxCount.repeaterProjectileEffect+1)%1000;
		if(fxCount.repeaterProjectileEffect == 0)
			CG_Printf("Possible fx spam in repeaterProjectileEffect!\n");
	} else if( id == cgs.effects.repeaterAltProjectileEffect ) {
		fxCount.repeaterAltProjectileEffect = (fxCount.repeaterAltProjectileEffect+1)%1000;
		if(fxCount.repeaterAltProjectileEffect == 0)
			CG_Printf("Possible fx spam in repeaterAltProjectileEffect!\n");
	} else if( id == cgs.effects.repeaterWallImpactEffect ) {
		fxCount.repeaterWallImpactEffect = (fxCount.repeaterWallImpactEffect+1)%1000;
		if(fxCount.repeaterWallImpactEffect == 0)
			CG_Printf("Possible fx spam in repeaterWallImpactEffect!\n");
	} else if( id == cgs.effects.repeaterFleshImpactEffect ) {
		fxCount.repeaterFleshImpactEffect = (fxCount.repeaterFleshImpactEffect+1)%1000;
		if(fxCount.repeaterFleshImpactEffect == 0)
			CG_Printf("Possible fx spam in repeaterFleshImpactEffect!\n");
	} else if( id == cgs.effects.repeaterAltWallImpactEffect ) {
		fxCount.repeaterAltWallImpactEffect = (fxCount.repeaterAltWallImpactEffect+1)%1000;
		if(fxCount.repeaterAltWallImpactEffect == 0)
			CG_Printf("Possible fx spam in repeaterAltWallImpactEffect!\n");
	} else if( id == cgs.effects.demp2ProjectileEffect ) {
		fxCount.demp2ProjectileEffect = (fxCount.demp2ProjectileEffect+1)%1000;
		if(fxCount.demp2ProjectileEffect == 0)
			CG_Printf("Possible fx spam in demp2ProjectileEffect!\n");
	} else if( id == cgs.effects.demp2WallImpactEffect ) {
		fxCount.demp2WallImpactEffect = (fxCount.demp2WallImpactEffect+1)%1000;
		if(fxCount.demp2WallImpactEffect == 0)
			CG_Printf("Possible fx spam in demp2WallImpactEffect!\n");
	} else if( id == cgs.effects.demp2FleshImpactEffect ) {
		fxCount.demp2FleshImpactEffect = (fxCount.demp2FleshImpactEffect+1)%1000;
		if(fxCount.demp2FleshImpactEffect == 0)
			CG_Printf("Possible fx spam in demp2FleshImpactEffect!\n");
	} else if( id == cgs.effects.flechetteShotEffect ) {
		fxCount.flechetteShotEffect = (fxCount.flechetteShotEffect+1)%1000;
		if(fxCount.flechetteShotEffect == 0)
			CG_Printf("Possible fx spam in flechetteShotEffect!\n");
	} else if( id == cgs.effects.flechetteAltShotEffect ) {
		fxCount.flechetteAltShotEffect = (fxCount.flechetteAltShotEffect+1)%1000;
		if(fxCount.flechetteAltShotEffect == 0)
			CG_Printf("Possible fx spam in flechetteAltShotEffect!\n");
	} else if( id == cgs.effects.flechetteWallImpactEffect ) {
		fxCount.flechetteWallImpactEffect = (fxCount.flechetteWallImpactEffect+1)%1000;
		if(fxCount.flechetteWallImpactEffect == 0)
			CG_Printf("Possible fx spam in flechetteWallImpactEffect!\n");
	} else if( id == cgs.effects.flechetteFleshImpactEffect ) {
		fxCount.flechetteFleshImpactEffect = (fxCount.flechetteFleshImpactEffect+1)%1000;
		if(fxCount.flechetteFleshImpactEffect == 0)
			CG_Printf("Possible fx spam in flechetteFleshImpactEffect!\n");
	} else if( id == cgs.effects.rocketShotEffect ) {
		fxCount.rocketShotEffect = (fxCount.rocketShotEffect+1)%1000;
		if(fxCount.rocketShotEffect == 0)
			CG_Printf("Possible fx spam in rocketShotEffect!\n");
	} else if( id == cgs.effects.rocketExplosionEffect ) {
		fxCount.rocketExplosionEffect = (fxCount.rocketExplosionEffect+1)%1000;
		if(fxCount.rocketExplosionEffect == 0)
			CG_Printf("Possible fx spam in rocketExplosionEffect!\n");
	} else if( id == cgs.effects.thermalExplosionEffect ) {
		fxCount.thermalExplosionEffect = (fxCount.thermalExplosionEffect+1)%1000;
		if(fxCount.thermalExplosionEffect == 0)
			CG_Printf("Possible fx spam in thermalExplosionEffect!\n");
	} else if( id == cgs.effects.thermalShockwaveEffect ) {
		fxCount.thermalShockwaveEffect = (fxCount.thermalShockwaveEffect+1)%1000;
		if(fxCount.thermalShockwaveEffect == 0)
			CG_Printf("Possible fx spam in thermalShockwaveEffect!\n");
	} else if( id == cgs.effects.tripmineLaserFX ) {
		fxCount.tripmineLaserFX = (fxCount.tripmineLaserFX+1)%1000;
		if(fxCount.tripmineLaserFX == 0)
			CG_Printf("Possible fx spam in tripmineLaserFX!\n");
	} else if( id == cgs.effects.tripmineGlowFX ) {
		fxCount.tripmineGlowFX = (fxCount.tripmineGlowFX+1)%1000;
		if(fxCount.tripmineGlowFX == 0)
			CG_Printf("Possible fx spam in tripmineGlowFX!\n");
	} else if( id == cgs.effects.forceLightning ) {
		fxCount.forceLightning = (fxCount.forceLightning+1)%1000;
		if(fxCount.forceLightning == 0)
			CG_Printf("Possible fx spam in forceLightning!\n");
	} else if( id == cgs.effects.forceLightningWide ) {
		fxCount.forceLightningWide = (fxCount.forceLightningWide+1)%1000;
		if(fxCount.forceLightningWide == 0)
			CG_Printf("Possible fx spam in forceLightningWide!\n");
	} else if( id == cgs.effects.forceDrain ) {
		fxCount.forceDrain = (fxCount.forceDrain+1)%1000;
		if(fxCount.forceDrain == 0)
			CG_Printf("Possible fx spam in forceDrain!\n");
	} else if( id == cgs.effects.forceDrainWide ) {
		fxCount.forceDrainWide = (fxCount.forceDrainWide+1)%1000;
		if(fxCount.forceDrainWide == 0)
			CG_Printf("Possible fx spam in forceDrainWide!\n");
	} else if( id == cgs.effects.forceDrained ) {
		fxCount.forceDrained = (fxCount.forceDrained+1)%1000;
		if(fxCount.forceDrained == 0)
			CG_Printf("Possible fx spam in forceDrained!\n");
	} else if( id == cgs.effects.turretShotEffect ) {
		fxCount.turretShotEffect = (fxCount.turretShotEffect+1)%1000;
		if(fxCount.turretShotEffect == 0)
			CG_Printf("Possible fx spam in turretShotEffect!\n");
	} else if( id == cgs.effects.itemCone ) {
		fxCount.itemCone = (fxCount.itemCone+1)%1000;
		if(fxCount.itemCone == 0)
			CG_Printf("Possible fx spam in itemCone!\n");
	} else if( id == cgs.effects.mSparks ) {
		fxCount.mSparks = (fxCount.mSparks+1)%1000;
		if(fxCount.mSparks == 0)
			CG_Printf("Possible fx spam in mSparks!\n");
	} else if( id == cgs.effects.mSaberCut ) {
		fxCount.mSaberCut = (fxCount.mSaberCut+1)%1000;
		if(fxCount.mSaberCut == 0)
			CG_Printf("Possible fx spam in mSaberCut!\n");
	} else if( id == cgs.effects.mTurretMuzzleFlash ) {
		fxCount.mTurretMuzzleFlash = (fxCount.mTurretMuzzleFlash+1)%1000;
		if(fxCount.mTurretMuzzleFlash == 0)
			CG_Printf("Possible fx spam in mTurretMuzzleFlash!\n");
	} else if( id == cgs.effects.mSaberBlock ) {
		fxCount.mSaberBlock = (fxCount.mSaberBlock+1)%1000;
		if(fxCount.mSaberBlock == 0)
			CG_Printf("Possible fx spam in mSaberBlock!\n");
	} else if( id == cgs.effects.mSaberBloodSparks ) {
		fxCount.mSaberBloodSparks = (fxCount.mSaberBloodSparks+1)%1000;
		if(fxCount.mSaberBloodSparks == 0)
			CG_Printf("Possible fx spam in mSaberBloodSparks!\n");
	} else if( id == cgs.effects.mSaberBloodSparksSmall ) {
		fxCount.mSaberBloodSparksSmall = (fxCount.mSaberBloodSparksSmall+1)%1000;
		if(fxCount.mSaberBloodSparksSmall == 0)
			CG_Printf("Possible fx spam in mSaberBloodSparksSmall!\n");
	} else if( id == cgs.effects.mSaberBloodSparksMid ) {
		fxCount.mSaberBloodSparksMid = (fxCount.mSaberBloodSparksMid+1)%1000;
		if(fxCount.mSaberBloodSparksMid == 0)
			CG_Printf("Possible fx spam in mSaberBloodSparksMid!\n");
	} else if( id == cgs.effects.mSpawn ) {
		fxCount.mSpawn = (fxCount.mSpawn+1)%1000;
		if(fxCount.mSpawn == 0)
			CG_Printf("Possible fx spam in mSpawn!\n");
	} else if( id == cgs.effects.mJediSpawn ) {
		fxCount.mJediSpawn = (fxCount.mJediSpawn+1)%1000;
		if(fxCount.mJediSpawn == 0)
			CG_Printf("Possible fx spam in mJediSpawn!\n");
	} else if( id == cgs.effects.mBlasterDeflect ) {
		fxCount.mBlasterDeflect = (fxCount.mBlasterDeflect+1)%1000;
		if(fxCount.mBlasterDeflect == 0)
			CG_Printf("Possible fx spam in mBlasterDeflect!\n");
	} else if( id == cgs.effects.mBlasterSmoke ) {
		fxCount.mBlasterSmoke = (fxCount.mBlasterSmoke+1)%1000;
		if(fxCount.mBlasterSmoke == 0)
			CG_Printf("Possible fx spam in mBlasterSmoke!\n");
	} else if( id == cgs.effects.mForceConfustionOld ) {
		fxCount.mForceConfustionOld = (fxCount.mForceConfustionOld+1)%1000;
		if(fxCount.mForceConfustionOld == 0)
			CG_Printf("Possible fx spam in mForceConfustionOld!\n");
	} else if( id == cgs.effects.mDisruptorDeathSmoke ) {
		fxCount.mDisruptorDeathSmoke = (fxCount.mDisruptorDeathSmoke+1)%1000;
		if(fxCount.mDisruptorDeathSmoke == 0)
			CG_Printf("Possible fx spam in mDisruptorDeathSmoke!\n");
	} else if( id == cgs.effects.mSparkExplosion ) {
		fxCount.mSparkExplosion = (fxCount.mSparkExplosion+1)%1000;
		if(fxCount.mSparkExplosion == 0)
			CG_Printf("Possible fx spam in mSparkExplosion!\n");
	} else if( id == cgs.effects.mTurretExplode ) {
		fxCount.mTurretExplode = (fxCount.mTurretExplode+1)%1000;
		if(fxCount.mTurretExplode == 0)
			CG_Printf("Possible fx spam in mTurretExplode!\n");
	} else if( id == cgs.effects.mEmplacedExplode ) {
		fxCount.mEmplacedExplode = (fxCount.mEmplacedExplode+1)%1000;
		if(fxCount.mEmplacedExplode == 0)
			CG_Printf("Possible fx spam in mEmplacedExplode!\n");
	} else if( id == cgs.effects.mEmplacedDeadSmoke ) {
		fxCount.mEmplacedDeadSmoke = (fxCount.mEmplacedDeadSmoke+1)%1000;
		if(fxCount.mEmplacedDeadSmoke == 0)
			CG_Printf("Possible fx spam in mEmplacedDeadSmoke!\n");
	} else if( id == cgs.effects.mTripmineExplosion ) {
		fxCount.mTripmineExplosion = (fxCount.mTripmineExplosion+1)%1000;
		if(fxCount.mTripmineExplosion == 0)
			CG_Printf("Possible fx spam in mTripmineExplosion!\n");
	} else if( id == cgs.effects.mDetpackExplosion ) {
		fxCount.mDetpackExplosion = (fxCount.mDetpackExplosion+1)%1000;
		if(fxCount.mDetpackExplosion == 0)
			CG_Printf("Possible fx spam in mDetpackExplosion!\n");
	} else if( id == cgs.effects.mFlechetteAltBlow ) {
		fxCount.mFlechetteAltBlow = (fxCount.mFlechetteAltBlow+1)%1000;
		if(fxCount.mFlechetteAltBlow == 0)
			CG_Printf("Possible fx spam in mFlechetteAltBlow!\n");
	} else if( id == cgs.effects.mStunBatonFleshImpact ) {
		fxCount.mStunBatonFleshImpact = (fxCount.mStunBatonFleshImpact+1)%1000;
		if(fxCount.mStunBatonFleshImpact == 0)
			CG_Printf("Possible fx spam in mStunBatonFleshImpact!\n");
	} else if( id == cgs.effects.mAltDetonate ) {
		fxCount.mAltDetonate = (fxCount.mAltDetonate+1)%1000;
		if(fxCount.mAltDetonate == 0)
			CG_Printf("Possible fx spam in mAltDetonate!\n");
	} else if( id == cgs.effects.mSparksExplodeNoSound ) {
		fxCount.mSparksExplodeNoSound = (fxCount.mSparksExplodeNoSound+1)%1000;
		if(fxCount.mSparksExplodeNoSound == 0)
			CG_Printf("Possible fx spam in mSparksExplodeNoSound!\n");
	} else if( id == cgs.effects.mTripMineLaster ) {
		fxCount.mTripMineLaster = (fxCount.mTripMineLaster+1)%1000;
		if(fxCount.mTripMineLaster == 0)
			CG_Printf("Possible fx spam in mTripMineLaster!\n");
	} else if( id == cgs.effects.mEmplacedMuzzleFlash ) {
		fxCount.mEmplacedMuzzleFlash = (fxCount.mEmplacedMuzzleFlash+1)%1000;
		if(fxCount.mEmplacedMuzzleFlash == 0)
			CG_Printf("Possible fx spam in mEmplacedMuzzleFlash!\n");
	} else if( id == cgs.effects.mConcussionAltRing ) {
		fxCount.mConcussionAltRing = (fxCount.mConcussionAltRing+1)%1000;
		if(fxCount.mConcussionAltRing == 0)
			CG_Printf("Possible fx spam in mConcussionAltRing!\n");
	} else if( id == cgs.effects.mHyperspaceStars ) {
		fxCount.mHyperspaceStars = (fxCount.mHyperspaceStars+1)%1000;
		if(fxCount.mHyperspaceStars == 0)
			CG_Printf("Possible fx spam in mHyperspaceStars!\n");
	} else if( id == cgs.effects.mBlackSmoke ) {
		fxCount.mBlackSmoke = (fxCount.mBlackSmoke+1)%1000;
		if(fxCount.mBlackSmoke == 0)
			CG_Printf("Possible fx spam in mBlackSmoke!\n");
	} else if( id == cgs.effects.mShipDestDestroyed ) {
		fxCount.mShipDestDestroyed = (fxCount.mShipDestDestroyed+1)%1000;
		if(fxCount.mShipDestDestroyed == 0)
			CG_Printf("Possible fx spam in mShipDestDestroyed!\n");
	} else if( id == cgs.effects.mShipDestBurning ) {
		fxCount.mShipDestBurning = (fxCount.mShipDestBurning+1)%1000;
		if(fxCount.mShipDestBurning == 0)
			CG_Printf("Possible fx spam in mShipDestBurning!\n");
	} else if( id == cgs.effects.mBobaJet ) {
		fxCount.mBobaJet = (fxCount.mBobaJet+1)%1000;
		if(fxCount.mBobaJet == 0)
			CG_Printf("Possible fx spam in mBobaJet!\n");
	} else if( id == cgs.effects.footstepMud ) {
		fxCount.footstepMud = (fxCount.footstepMud+1)%1000;
		if(fxCount.footstepMud == 0)
			CG_Printf("Possible fx spam in footstepMud!\n");
	} else if( id == cgs.effects.footstepSand ) {
		fxCount.footstepSand = (fxCount.footstepSand+1)%1000;
		if(fxCount.footstepSand == 0)
			CG_Printf("Possible fx spam in footstepSand!\n");
	} else if( id == cgs.effects.footstepSnow ) {
		fxCount.footstepSnow = (fxCount.footstepSnow+1)%1000;
		if(fxCount.footstepSnow == 0)
			CG_Printf("Possible fx spam in footstepSnow!\n");
	} else if( id == cgs.effects.footstepGravel ) {
		fxCount.footstepGravel = (fxCount.footstepGravel+1)%1000;
		if(fxCount.footstepGravel == 0)
			CG_Printf("Possible fx spam in footstepGravel!\n");
	} else if( id == cgs.effects.landingMud ) {
		fxCount.landingMud = (fxCount.landingMud+1)%1000;
		if(fxCount.landingMud == 0)
			CG_Printf("Possible fx spam in landingMud!\n");
	} else if( id == cgs.effects.landingSand ) {
		fxCount.landingSand = (fxCount.landingSand+1)%1000;
		if(fxCount.landingSand == 0)
			CG_Printf("Possible fx spam in landingSand!\n");
	} else if( id == cgs.effects.landingDirt ) {
		fxCount.landingDirt = (fxCount.landingDirt+1)%1000;
		if(fxCount.landingDirt == 0)
			CG_Printf("Possible fx spam in landingDirt!\n");
	} else if( id == cgs.effects.landingSnow ) {
		fxCount.landingSnow = (fxCount.landingSnow+1)%1000;
		if(fxCount.landingSnow == 0)
			CG_Printf("Possible fx spam in landingSnow!\n");
	} else if( id == cgs.effects.landingGravel ) {
		fxCount.landingGravel = (fxCount.landingGravel+1)%1000;
		if(fxCount.landingGravel == 0)
			CG_Printf("Possible fx spam in landingGravel!\n");
	} else if( id == cgs.effects.waterSplash ) {
		fxCount.waterSplash = (fxCount.waterSplash+1)%1000;
		if(fxCount.waterSplash == 0)
			CG_Printf("Possible fx spam in waterSplash!\n");
	} else if( id == cgs.effects.lavaSplash ) {
		fxCount.lavaSplash = (fxCount.lavaSplash+1)%1000;
		if(fxCount.lavaSplash == 0)
			CG_Printf("Possible fx spam in lavaSplash!\n");
	} else if( id == cgs.effects.acidSplash ) {
		fxCount.acidSplash = (fxCount.acidSplash+1)%1000;
		if(fxCount.acidSplash == 0)
			CG_Printf("Possible fx spam in acidSplash!\n");
	} else CG_Printf( "Unknown FX id %d\n", id );
#endif
...
void trap_TrueMalloc(void **ptr, int size)
{
	...
	if( ptr == 0 ) CG_Printf("WARNING: trap_TrueMalloc failed to create memblock of size %d.\n", size);
}
