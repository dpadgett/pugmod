...
int main()
{
	printf("Your system appears to be compatible with PUGMod.\n");
	system("PAUSE");
	return 0;
}
#endif
...
vmCvar_t	pug_demospec;
vmCvar_t	cam_autorecord;
vmCvar_t	cam_autosound;
vmCvar_t	ui_fragsOnly;
vmCvar_t	ui_noScope;
vmCvar_t	pug_demos_cameraMode;
vmCvar_t	pug_demos_UnlockThirdpersonPitch;
vmCvar_t	pug_demos_HideLocalEntities;
vmCvar_t	pug_demos_HidePacketEntities;
vmCvar_t	pug_demos_Timescalelesscams;
vmCvar_t	debug_cvar;
//vmCvar_t	pug_demos_fixLocalhostDemo;
vmCvar_t	cg_noChatSound;
vmCvar_t	cg_blendScreenshots;
vmCvar_t	mme_aviFormat;
vmCvar_t	mme_screenShotFormat;
vmCvar_t	mme_screenShotGamma;
vmCvar_t	mme_jpegQuality;
vmCvar_t	mme_jpegDownsampleChroma;
vmCvar_t	mme_jpegOptimizeHuffman;
vmCvar_t	mme_tgaCompression;
vmCvar_t	mme_pngCompression;
vmCvar_t	mme_skykey;
vmCvar_t	mme_blurFrames;
vmCvar_t	mme_renderWidth;
vmCvar_t	mme_renderHeight;
vmCvar_t	mme_blurFrames;
vmCvar_t	mme_blurType;
vmCvar_t	mme_blurOverlap;
vmCvar_t	mme_blurGamma;
vmCvar_t	mme_workMegs;
vmCvar_t	mme_depthFocus;
vmCvar_t	mme_depthRange;
vmCvar_t	mme_captureName;
vmCvar_t	mme_saveShot;
vmCvar_t	mme_saveStencil;
vmCvar_t	mme_saveDepth;
vmCvar_t	mme_screenshotName;
vmCvar_t	pug_demos_autoChaseCam;
vmCvar_t	cg_fixRocket;
vmCvar_t	cg_drawSvFPS;
...
Ghoul2 Insert End
*/
	{ &pug_demospec, "pug_demospec", "-1", 0 },
	{ &cam_autorecord, "cam_autorecord", "0", CVAR_NORESTART },
	{ &cam_autosound, "cam_autosound", "0", CVAR_NORESTART },
	{ &ui_fragsOnly, "ui_fragsOnly", "0", CVAR_NORESTART },
	{ &ui_noScope, "ui_noScope", "0", CVAR_NORESTART },
	{ &pug_demos_cameraMode, "pug_demos_cameraMode", "0", CVAR_NORESTART },
	{ &pug_demos_UnlockThirdpersonPitch, "pug_demos_UnlockThirdpersonPitch", "0", CVAR_NORESTART },
	{ &pug_demos_HideLocalEntities, "pug_demos_HideLocalEntities", "0", CVAR_NORESTART },
	{ &pug_demos_HidePacketEntities, "pug_demos_HidePacketEntities", "0", CVAR_NORESTART },
	{ &pug_demos_Timescalelesscams, "pug_demos_Timescalelesscams", "0", CVAR_NORESTART },
	{ &debug_cvar, "debug_cvar", "0", CVAR_NORESTART },
//	{ &pug_demos_fixLocalhostDemo, "pug_demos_fixLocalhostDemo", "0", CVAR_NORESTART },
	{ &cg_noChatSound, "cg_noChatSound", "0", CVAR_NORESTART },
	{ &cg_blendScreenshots, "cg_blendScreenshots", "0", CVAR_NORESTART },
	
	{ &mme_aviFormat, "mme_aviFormat", "0", CVAR_ARCHIVE },
	{ &mme_jpegQuality, "mme_jpegQuality", "90", CVAR_ARCHIVE },
	{ &mme_jpegDownsampleChroma, "mme_jpegDownsampleChroma", "0", CVAR_ARCHIVE },
	{ &mme_jpegOptimizeHuffman, "mme_jpegOptimizeHuffman", "1", CVAR_ARCHIVE },
	{ &mme_screenShotFormat, "mme_screenShotFormat", "png", CVAR_ARCHIVE },
	{ &mme_screenShotGamma, "mme_screenShotGamma", "0", CVAR_ARCHIVE },
	{ &mme_tgaCompression, "mme_tgaCompression", "1", CVAR_ARCHIVE },
	{ &mme_pngCompression, "mme_pngCompression", "5", CVAR_ARCHIVE },
	{ &mme_skykey, "mme_skykey", "0", CVAR_ARCHIVE },
	{ &mme_renderWidth, "mme_renderWidth", "0", CVAR_LATCH | CVAR_ARCHIVE },
	{ &mme_renderHeight, "mme_renderHeight", "0", CVAR_LATCH | CVAR_ARCHIVE },
	

	{ &mme_blurFrames, "mme_blurFrames", "0", CVAR_ARCHIVE },
	{ &mme_blurOverlap, "mme_blurOverlap", "0", CVAR_ARCHIVE },
	{ &mme_blurType, "mme_blurType", "0", CVAR_ARCHIVE },
	{ &mme_blurGamma, "mme_blurGamma", "0", CVAR_ARCHIVE },
	{ &mme_depthRange, "mme_depthRange", "0", CVAR_ARCHIVE },
	{ &mme_depthFocus, "mme_depthFocus", "0", CVAR_ARCHIVE },
	{ &mme_saveStencil, "mme_saveStencil", "0", CVAR_ARCHIVE },
	{ &mme_saveDepth, "mme_saveDepth", "0", CVAR_ARCHIVE },
	{ &mme_saveShot, "mme_saveShot", "1", CVAR_ARCHIVE },
	{ &mme_workMegs, "mme_workMegs", "128", CVAR_LATCH | CVAR_ARCHIVE },
	{ &mme_screenshotName, "mme_screenshotName", "shot", CVAR_NORESTART },
	{ &pug_demos_autoChaseCam, "pug_demos_autoChaseCam", "0", CVAR_NORESTART },
	{ &cg_fixRocket, "cg_fixRocket", "0", CVAR_ARCHIVE },
	{ &cg_drawSvFPS, "cg_drawSvFPS", "0", CVAR_ARCHIVE },
...
//	CG_LoadingString( "sounds" );
	...
	cgs.media.smokePuffShader			= trap_R_RegisterShader( "gfx/effects/alpha_smoke" );
	cgs.media.flamejetShader			= trap_R_RegisterShader( "gfx/effects/flamejet" );
	cgs.media.fireShaders[0]			= trap_R_RegisterShader( "gfx/effects/fire2" );
	cgs.media.fireShaders[1]			= trap_R_RegisterShader( "gfx/effects/fire3" );
	cgs.media.fireShaders[2]			= trap_R_RegisterShader( "gfx/effects/fire4" );
	cgs.media.whiteFlare				= trap_R_RegisterShader( "gfx/effects/whiteFlarea" );
...
int CG_Cvar_Int(const char *cvar) {
	char buff[128];
	memset(buff, 0, sizeof(buff));
	trap_Cvar_VariableStringBuffer(cvar, buff, sizeof(buff));
	return atoi(buff);
...
const char *CG_Cvar_String(const char *cvar) {
	static char buff[2][MAX_STRING_CHARS];
	static int toggle;
	
	toggle ^= 1;
	
	memset(buff[toggle], 0, sizeof(buff[0]));
	trap_Cvar_VariableStringBuffer(cvar, buff[toggle], sizeof(buff[0]));
	return buff[toggle];
}
...
void (WINAPI * trueglFrustum)(GLdouble,GLdouble,GLdouble,GLdouble,GLdouble,GLdouble) = glFrustum;
void WINAPI my_glFrustum(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
void (WINAPI * trueglMatrixMode)( GLenum mode ) = glMatrixMode;
void WINAPI my_glMatrixMode( GLenum mode );
void (WINAPI * trueglLoadMatrixf)( const GLfloat *mat ) = glLoadMatrixf;
...
//	DetourAttach(&(PVOID&)trueglFrustum, Hooked::glFrustum);
	DetourAttach((PVOID *)&trueglFrustum, my_glFrustum);
	DetourAttach((PVOID *)&trueglMatrixMode, my_glMatrixMode);
	DetourAttach((PVOID *)&trueglLoadMatrixf, my_glLoadMatrixf);
...
//	DetourAttach(&(PVOID&)trueglLoadMatrixf, Hooked::glLoadMatrixf);
	...
	assert(error == NO_ERROR/*,"DetourTransactionCommit: %d",error*/);
...
//	CG_LoadFonts();
	...
	trap_Cvar_Set( "levelStartTime", s );
...
//	DetourDetach(&(PVOID&)truegluPerspective, Hooked::gluPerspective);
	DetourDetach((PVOID *)&trueglFrustum, my_glFrustum);
//	DetourDetach(&(PVOID&)trueglViewPort, Hooked::glViewPort);
	DetourDetach((PVOID *)&trueglMatrixMode, my_glMatrixMode);
	DetourDetach((PVOID *)&trueglLoadMatrixf, my_glLoadMatrixf);
