...
//	float	len;
	...
	/*if( debug_cvar.integer ) {
		vec3_t tmp;
		VectorSet( tmp, -1358.979248f, -1441.091431f, 169.510559f );
		VectorSubtract( tmp, start, tmp );
		if( VectorLength( tmp ) < 75.0f ) trap_Cvar_Set( "cl_freezedemo", "1" );
		//else CG_Printf( "%f\n", VectorLength( tmp ) );
	}*/
