...
typedef rectDef_t JKA_Rectangle;

// FIXME: do something to separate text vs window stuff
typedef struct {
  JKA_Rectangle rect;                 // client coord rectangle
  JKA_Rectangle rectClient;           // screen coord rectangle
  const char *name;               //
  ...
  JKA_Rectangle rectEffects;          // for various effects
  JKA_Rectangle rectEffects2;         // for various effects
...
typedef struct itemDef_s {
	...
	JKA_Rectangle	textRect;					// rectangle the text ( if any ) consumes     
